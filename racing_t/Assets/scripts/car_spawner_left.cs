...
public class car_spawner_left : MonoBehaviour {
	...
	void Update () {
		...
		if (timer <= 0) 
		{
			Vector2 carPos = new Vector2 (Random.Range (-1.88f, 0f), transform.position.y); //get random position in the area above the camera
